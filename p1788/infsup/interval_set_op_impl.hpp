...
#ifndef LIBIEEEP1788_P1788_INFSUP_INTERVAL_SET_OP_IMPL_HPP
#define LIBIEEEP1788_P1788_INFSUP_INTERVAL_SET_OP_IMPL_HPP
...
interval<T, Flavor> intersect(interval<T, Flavor> const& x,
...
///
template<typename T, template<typename> class Flavor>
interval<T, Flavor> hull(interval<T, Flavor> const& x,
                                interval<T, Flavor> const& y) {
...
#endif // LIBIEEEP1788_P1788_INFSUP_INTERVAL_SET_OP_IMPL_HPP
