...
#ifndef LIBIEEEP1788_P1788_INFSUP_DECORATED_INTERVAL_CANCEL_FUNC_IMPL_HPP
#define LIBIEEEP1788_P1788_INFSUP_DECORATED_INTERVAL_CANCEL_FUNC_IMPL_HPP
...
decorated_interval<T, Flavor> cancel_plus(decorated_interval<T, Flavor> const& a,
                                       decorated_interval<T, Flavor> const& b) {     ///< Required, necessary for bare intervals? see, 11.11.6 // TODO nicht fuer bare interval
    return decorated_interval<T, Flavor>(Flavor<T>::cancel_plus_dec(a.rep_, b.rep_));
}
...
template<typename T, template<typename> class Flavor>
decorated_interval<T, Flavor> cancel_minus(decorated_interval<T, Flavor> const& a,
                                        decorated_interval<T, Flavor> const& b) {    ///< Required, necessary for bare intervals? see, 11.11.6 // TODO nicht fuer bare interval
    return decorated_interval<T, Flavor>(Flavor<T>::cancel_minus_dec(a.rep_, b.rep_));
}
...
#endif // LIBIEEEP1788_P1788_INFSUP_DECORATED_INTERVAL_CANCEL_FUNC_IMPL_HPP
