...
#ifndef LIBIEEEP1788_P1788_INFSUP_INTERVAL_BOOL_FUNC_IMPL_HPP
#define LIBIEEEP1788_P1788_INFSUP_INTERVAL_BOOL_FUNC_IMPL_HPP
...
bool is_empty(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
bool is_entire(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
bool is_equal(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool operator==(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
    return is_equal(x, y);
}
...
///
template<typename T, template<typename> class Flavor>
bool contained_in(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool contains(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool less(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool greater(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
    return less(y, x);
}
...
///
template<typename T, template<typename> class Flavor>
bool precedes(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool succeeds(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
    return precedes(y, x);
}
...
///
template<typename T, template<typename> class Flavor>
bool is_interior(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool contains_interior(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool strictly_less(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool strictly_greater(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool strictly_precedes(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool strictly_succeeds(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
///
template<typename T, template<typename> class Flavor>
bool are_disjoint(interval<T, Flavor> const& x, interval<T, Flavor> const& y) {
...
#endif // LIBIEEEP1788_P1788_INFSUP_INTERVAL_BOOL_FUNC_IMPL_HPP
