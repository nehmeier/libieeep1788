...
#ifndef LIBIEEEP1788_P1788_INFSUP_INTERVAL_NUM_FUNC_IMPL_HPP
#define LIBIEEEP1788_P1788_INFSUP_INTERVAL_NUM_FUNC_IMPL_HPP
...
T inf(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
T sup(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
T mid(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
T rad(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
std::pair<T, T> mid_rad(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
T wid(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
T mag(interval<T, Flavor> const& x) {
...
///
template<typename T, template<typename> class Flavor>
T mig(interval<T, Flavor> const& x) {
...
#endif // LIBIEEEP1788_P1788_INFSUP_INTERVAL_NUM_FUNC_IMPL_HPP
