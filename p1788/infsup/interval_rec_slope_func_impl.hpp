...
#ifndef LIBIEEEP1788_P1788_INFSUP_INTERVAL_REC_SLOPE_FUNC_IMPL_HPP
#define LIBIEEEP1788_P1788_INFSUP_INTERVAL_REC_SLOPE_FUNC_IMPL_HPP
...
interval<T, Flavor> exp_slope1(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> exp_slope2(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> log_slope1(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> log_slope2(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> cos_slope2(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> sin_slope3(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> asin_slope3(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> atan_slope3(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> cosh_slope2(interval<T, Flavor> const& x) {
...
template<typename T, template<typename> class Flavor>
interval<T, Flavor> sinh_slope3(interval<T, Flavor> const& x) {
...
#endif // LIBIEEEP1788_P1788_INFSUP_INTERVAL_REC_SLOPE_FUNC_IMPL_HPP
