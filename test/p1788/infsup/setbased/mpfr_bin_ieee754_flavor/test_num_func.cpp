...
#define BOOST_TEST_MODULE "Numeric functions on intervals [infsup/interval, infsup/setbased/mpfr_bin_ieee754_flavor]"
...
BOOST_AUTO_TEST_CASE(minimal_rad_test)
{
    ...
    BOOST_CHECK_EQUAL( rad(I<double>(0X1P+0,  0X1.0000000000003P+0)), 0X1P-51);
