...
BOOST_AUTO_TEST_CASE(integration_pow_test)
{
    ...
    BOOST_CHECK_EQUAL( DI<double>::pow(DI<double>(0.0,1.5, DEC::com), DI<double>(0.1,2.5, DEC::dac)), DI<double>(0.0,std::stod("0X1.60B9FD68A4555P+1"), DEC::dac) );
    BOOST_CHECK_EQUAL( decoration( DI<double>::pow(DI<double>(0.0,1.5, DEC::com), DI<double>(0.1,2.5, DEC::dac)) ), DEC::dac );
    BOOST_CHECK_EQUAL( DI<float>::pow(DI<double>(-0.0,0.5), DI<double>(0.1,0.1)), DI<float>(0.0f,std::stof("0X1.DDB682P-1"), DEC::com) );
    BOOST_CHECK_EQUAL( decoration( DI<float>::pow(DI<double>(-0.0,0.5), DI<double>(0.1,0.1)) ), DEC::com );
}
...
BOOST_AUTO_TEST_CASE(integration_atan2_test)
{
    ...
    BOOST_CHECK_EQUAL( I<float>::atan2(I<double>(-2.0, 0.0), I<double>(-2.0, 0.0)), I<float>(std::stof("-0X1.921FB6P+1"), std::stof("0X1.921FB6P+1")) );
    ...
    BOOST_CHECK_EQUAL( atan2(DI<double>(-2.0,0.0), DI<double>(-2.0,0.0) ), DI<double>(std::stod("-0X1.921FB54442D19P+1"), std::stod("0X1.921FB54442D19P+1"),DEC::trv) );
...
BOOST_AUTO_TEST_CASE(integration_ceil_test)
{
    ...
    BOOST_CHECK_EQUAL( ceil(DI<double>(1.1,2.0,DEC::com)), DI<double>(2.0,2.0,DEC::dac) );
    BOOST_CHECK_EQUAL( decoration( ceil(DI<double>(1.1,2.0,DEC::com)) ), DEC::dac );
...
BOOST_AUTO_TEST_CASE(integration_round_ties_to_even_test)
{
    ...
    BOOST_CHECK_EQUAL( round_ties_to_even(DI<double>(1.5,1.9,DEC::com)), DI<double>(2.0,2.0,DEC::dac) );
    BOOST_CHECK_EQUAL( decoration( round_ties_to_even(DI<double>(1.5,1.9,DEC::com)) ), DEC::dac );
...
BOOST_AUTO_TEST_CASE(integration_round_ties_to_away_test)
{
    ...
    BOOST_CHECK_EQUAL( round_ties_to_away(DI<double>(1.5,1.9,DEC::com)), DI<double>(2.0,2.0,DEC::dac) );
    BOOST_CHECK_EQUAL( decoration( round_ties_to_away(DI<double>(1.5,1.9,DEC::com)) ), DEC::dac );
