...
BOOST_AUTO_TEST_CASE(minimal_pown_rev_test)
{
    ...
    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.0,INF_D), 2), REP<double>(-INF_D,INF_D) );
...
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(F<double>::empty(), -2) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(F<double>::entire(), -2), REP<double>(0.0,INF_D) );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(0.0,0.0), -2) ) );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(-0.0,-0.0), -2) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(13.1,13.1), -2), REP<double>(std::stod("0X1.7DE3A077D1568P-8"),std::stod("0X1.7DE3A077D1569P-8")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-7451.145,-7451.145), -2), REP<double>(std::stod("0X1.3570290CD6E14P-26"),std::stod("0X1.3570290CD6E15P-26")) );
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -2), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );    //not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -2), REP<double>(std::stod("0X0P+0"),std::stod("0X0.0000000000001P-1022")) );     // F<double>::subnormalized
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -2), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -2), REP<double>(std::stod("0X0P+0"),std::stod("0X0.0000000000001P-1022")) );   // F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.0,INF_D), -2), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-0.0,INF_D), -2), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,0.0), -2), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,-0.0), -2), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-324.3,2.5), -2), REP<double>(std::stod("0X1.3F0C482C977C9P-17"),INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.01,2.33), -2), REP<double>(std::stod("0X1.793D85EF38E47P-3"),std::stod("0X1.388P+13")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-1.9,-0.33), -2), REP<double>(std::stod("0X1.1BA81104F6C8P-2"),std::stod("0X1.25D8FA1F801E1P+3")) );
//
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(F<double>::empty(), -8) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(F<double>::entire(), -8), REP<double>(0.0,INF_D) );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(0.0,0.0), -8) ) );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(-0.0,-0.0), -8) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(13.1,13.1), -8), REP<double>(std::stod("0X1.3CEF39247CA6DP-30"),std::stod("0X1.3CEF39247CA6EP-30")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-7451.145,-7451.145), -8), REP<double>(std::stod("0X1.113D9EF0A99ACP-103"),std::stod("0X1.113D9EF0A99ADP-103")) );
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -8), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );    not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -8), REP<double>(std::stod("0X0P+0"),std::stod("0X0.0000000000001P-1022")) );    // F<double>::subnormalized
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -8), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -8), REP<double>(std::stod("0X0P+0"),std::stod("0X0.0000000000001P-1022")) );   // F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.0,INF_D), -8), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-0.0,INF_D), -8), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,0.0), -8), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,-0.0), -8), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-324.3,2.5), -8), REP<double>(std::stod("0X1.34CC3764D1E0CP-67"),INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.01,2.33), -8), REP<double>(std::stod("0X1.2DC80DB11AB7CP-10"),std::stod("0X1.1C37937E08P+53")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-1.9,-0.33), -8), REP<double>(std::stod("0X1.81E104E61630DP-8"),std::stod("0X1.BC64F21560E34P+12")) );
//
//
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(F<double>::empty(), -1) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(F<double>::entire(), -1), F<double>::entire() );
...
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(-0.0,-0.0), -1) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(13.1,13.1), -1), REP<double>(std::stod("0X1.38ABF82EE6986P-4"),std::stod("0X1.38ABF82EE6987P-4")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-7451.145,-7451.145), -1), REP<double>(std::stod("-0X1.197422C9048BFP-13"),std::stod("-0X1.197422C9048BEP-13")) );
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -1), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -1), REP<double>(std::stod("0X0.4P-1022"),std::stod("0X0.4000000000001P-1022")) );   // F<double>::subnormalized
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -1), REP<double>(std::stod("-0X1P-1022"),std::stod("-0X0P+0")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -1), REP<double>(std::stod("-0X0.4000000000001P-1022"),std::stod("-0X0.4P-1022")) );   // F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.0,INF_D), -1), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-0.0,INF_D), -1), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,0.0), -1), REP<double>(-INF_D,0.0) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,-0.0), -1), REP<double>(-INF_D,0.0) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-324.3,2.5), -1), F<double>::entire() );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.01,2.33), -1), REP<double>(std::stod("0X1.B77C278DBBE13P-2"),std::stod("0X1.9P+6")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-1.9,-0.33), -1), REP<double>(std::stod("-0X1.83E0F83E0F83EP+1"),std::stod("-0X1.0D79435E50D79P-1")) );
//
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(F<double>::empty(), -3) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(F<double>::entire(), -3), F<double>::entire() );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(0.0,0.0), -3) ) );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(-0.0,-0.0), -3) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(13.1,13.1), -3), REP<double>(std::stod("0X1.D26DF4D8B1831P-12"),std::stod("0X1.D26DF4D8B1832P-12")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-7451.145,-7451.145), -3), REP<double>(std::stod("-0X1.54347DED91B19P-39"),std::stod("-0X1.54347DED91B18P-39")) );
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -3), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -3), REP<double>(std::stod("0X0P+0"),std::stod("0X0.0000000000001P-1022")) );   // F<double>::subnormalized
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -3), REP<double>(std::stod("-0X1P-1022"),std::stod("-0X0P+0")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -3), REP<double>(std::stod("-0X0.0000000000001P-1022"),std::stod("-0X0P+0")) );   // F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.0,INF_D), -3), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-0.0,INF_D), -3), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,0.0), -3), REP<double>(-INF_D,0.0) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,-0.0), -3), REP<double>(-INF_D,0.0) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-324.3,2.5), -3), F<double>::entire() );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.01,2.33), -3), REP<double>(std::stod("0X1.43CFBA61AACABP-4"),std::stod("0X1.E848P+19")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-1.9,-0.33), -3), REP<double>(std::stod("-0X1.BD393CE9E8E7CP+4"),std::stod("-0X1.2A95F6F7C066CP-3")) );
//
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(F<double>::empty(), -7) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(F<double>::entire(), -7), F<double>::entire() );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(0.0,0.0), -7) ) );
//    BOOST_CHECK( F<double>::is_empty( F<double>::pown_rev(REP<double>(-0.0,-0.0), -7) ) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(13.1,13.1), -7), REP<double>(std::stod("0X1.037D76C912DBCP-26"),std::stod("0X1.037D76C912DBDP-26")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-7451.145,-7451.145), -7), REP<double>(std::stod("-0X1.F10F41FB8858FP-91"),std::stod("-0X1.F10F41FB8858EP-91")) );
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -7), REP<double>(std::stod("0X0P+0"),std::stod("0X1P-1022")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(MAX_D,MAX_D), -7), REP<double>(std::stod("0X0P+0"),std::stod("0X0.0000000000001P-1022")) );   // F<double>::subnormalized
////    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -7), REP<double>(std::stod("-0X1P-1022"),std::stod("-0X0P+0")) );   not F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-MAX_D,-MAX_D), -7), REP<double>(std::stod("-0X0.0000000000001P-1022"),std::stod("-0X0P+0")) );   // F<double>::subnormalized
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.0,INF_D), -7), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-0.0,INF_D), -7), REP<double>(0.0,INF_D) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,0.0), -7), REP<double>(-INF_D,0.0) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-INF_D,-0.0), -7), REP<double>(-INF_D,0.0) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-324.3,2.5), -7), F<double>::entire() );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(0.01,2.33), -7), REP<double>(std::stod("0X1.5F934D64162A9P-9"),std::stod("0X1.6BCC41E9P+46")) );
//    BOOST_CHECK_EQUAL( F<double>::pown_rev(REP<double>(-1.9,-0.33), -7), REP<double>(std::stod("-0X1.254CDD3711DDBP+11"),std::stod("-0X1.6E95C4A761E19P-7")) );
