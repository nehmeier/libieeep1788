...
BOOST_AUTO_TEST_CASE(minimal_mixedtype_is_member_dec_test)
{
    ...
    BOOST_CHECK(F<double>::is_member(0.0f, REP_DEC<double>(REP<double>(0.0,-0.0), DEC::trv)));
    BOOST_CHECK(F<float>::is_member(5.0, REP_DEC<float>(REP<float>(5.0f, 12.4f), DEC::def)));
    BOOST_CHECK(F<float>::is_member(6.3, REP_DEC<float>(REP<float>(5.0f, 12.4f), DEC::dac)));
    BOOST_CHECK(F<float>::is_member(0.0, REP_DEC<float>(REP<float>(-INF_F,INF_F), DEC::trv)));
    BOOST_CHECK(F<float>::is_member(5.0, REP_DEC<float>(REP<float>(-INF_F,INF_F), DEC::def)));
    BOOST_CHECK(F<double>::is_member(6.3, REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::dac)));
    BOOST_CHECK(F<double>::is_member(12.4, REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::trv)));
    BOOST_CHECK(F<double>::is_member(MAX_D, REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::def)));
    BOOST_CHECK(F<float>::is_member(-MAX_D, REP_DEC<float>(REP<float>(-INF_F,INF_F), DEC::dac)));
    BOOST_CHECK(F<double>::is_member(MIN_D, REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::trv)));
    BOOST_CHECK(F<float>::is_member(-MIN_D, REP_DEC<float>(REP<float>(-INF_F,INF_F), DEC::def)));

    BOOST_CHECK(!F<float>::is_member(12.4, REP_DEC<float>(REP<float>(5.0f, 12.4f), DEC::trv)));
    ...
    BOOST_CHECK(!F<float>::is_member(111110.0, REP_DEC<float>(REP<float>(-0.0f,-0.0f), DEC::def)));
    ...
    BOOST_CHECK(!F<float>::is_member(-INF_D, REP_DEC<float>(REP<float>(NaN_F,NaN_F), DEC::trv)));
    BOOST_CHECK(!F<float>::is_member(-INF_D, REP_DEC<float>(REP<float>(NaN_F,NaN_F), DEC::ill)));
    BOOST_CHECK(!F<float>::is_member(INF_D, REP_DEC<float>(REP<float>(NaN_F,NaN_F), DEC::trv)));
    BOOST_CHECK(!F<float>::is_member(INF_D, REP_DEC<float>(REP<float>(NaN_F,NaN_F), DEC::ill)));
    ...
    BOOST_CHECK(!F<float>::is_member(INF_D, REP_DEC<float>(REP<float>(-INF_F,INF_F), DEC::def)));
    BOOST_CHECK(!F<float>::is_member(NaN_D, REP_DEC<float>(REP<float>(-INF_F,INF_F), DEC::dac)));
