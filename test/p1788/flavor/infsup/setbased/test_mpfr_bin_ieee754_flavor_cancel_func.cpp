...
BOOST_AUTO_TEST_CASE(minimal_cancel_plus_dec_test)
{
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-5.1,-0.0), DEC::com), REP_DEC<double>(REP<double>(0.0,5.0), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999998P-4"),0.0), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-5.1,-1.0), DEC::com), REP_DEC<double>(REP<double>(1.0,5.0), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999998P-4"),0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-5.0,-0.9), DEC::com), REP_DEC<double>(REP<double>(1.0,5.0), DEC::def)), REP_DEC<double>(REP<double>(0.0, std::stod("0X1.9999999999998P-4")), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-5.0,-1.0), DEC::dac), REP_DEC<double>(REP<double>(1.0,5.0), DEC::com)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-10.1, 5.0), DEC::dac), REP_DEC<double>(REP<double>(-5.0,10.0), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999998P-4"),0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-10.0, 5.1), DEC::def), REP_DEC<double>(REP<double>(-5.0,10.0), DEC::def)), REP_DEC<double>(REP<double>(0.0,std::stod("0X1.999999999998P-4")), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-10.0, 5.0), DEC::def), REP_DEC<double>(REP<double>(-5.0,10.0), DEC::com)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(0.9, 5.1), DEC::com), REP_DEC<double>(REP<double>(-5.0,-1.0), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1.9999999999998P-4"),std::stod("0X1.999999999998P-4")), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(1.0, 5.0), DEC::dac), REP_DEC<double>(REP<double>(-5.0,-1.0), DEC::dac)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::dac) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(std::stod("-0X1.999999999999AP-4"),std::stod("0X1.FFFFFFFFFFFFP+0")), DEC::dac), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999999AP-4"),0.01), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1.70A3D70A3D70BP-4"),std::stod("0X1.E666666666657P+0")), DEC::dac) );

    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(MAX_D,MAX_D), DEC::com), REP_DEC<double>(REP<double>(MAX_D,MAX_D), DEC::com)), REP_DEC<double>(REP<double>(MAX_D,INF_D), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::com), REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::com)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::dac), REP_DEC<double>(REP<double>(std::stod("-0X1.FFFFFFFFFFFFEP+1023"),MAX_D), DEC::com)), REP_DEC<double>(REP<double>(0.0,std::stod("0X1P+971")), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::dac), REP_DEC<double>(REP<double>(-MAX_D,std::stod("0X1.FFFFFFFFFFFFEP+1023")), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1P+971"),0.0), DEC::dac) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_plus(REP_DEC<double>(REP<double>(std::stod("-0X1P+0"),std::stod("0X1.FFFFFFFFFFFFFP-53")), DEC::dac), REP_DEC<double>(REP<double>(std::stod("-0X1P+0"),std::stod("0X1.FFFFFFFFFFFFEP-53")), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1.FFFFFFFFFFFFFP-1"),std::stod("-0X1.FFFFFFFFFFFFEP-1")), DEC::dac) );
...
{
    BOOST_CHECK_EQUAL( F<float>::cancel_plus(REP_DEC<double>(REP<double>(-5.0,-0.9), DEC::com), REP_DEC<double>(REP<double>(1.0,5.0), DEC::com)), REP_DEC<float>(REP<float>(0.0f, std::stof("0X1.99999AP-4")), DEC::com) );
    BOOST_CHECK_EQUAL( F<float>::cancel_plus(REP_DEC<double>(REP<double>(-5.1,-0.9), DEC::dac), REP_DEC<double>(REP<double>(1.0,5.0), DEC::def)), REP_DEC<float>(REP<float>(std::stof("-0X1.99999AP-4"),std::stof("0X1.99999AP-4")), DEC::def) );
...
BOOST_AUTO_TEST_CASE(minimal_cancel_minus_dec_test)
{
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-5.1,-0.0), DEC::com), REP_DEC<double>(REP<double>(-5.0, 0.0), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999998P-4"),0.0), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-5.1,-1.0), DEC::dac), REP_DEC<double>(REP<double>(-5.0, -1.0), DEC::com)), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999998P-4"),0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-5.0,-0.9), DEC::def), REP_DEC<double>(REP<double>(-5.0, -1.0), DEC::com)), REP_DEC<double>(REP<double>(0.0, std::stod("0X1.9999999999998P-4")), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-5.0,-1.0), DEC::com), REP_DEC<double>(REP<double>(-5.0, -1.0), DEC::dac)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-10.1, 5.0), DEC::dac), REP_DEC<double>(REP<double>(-10.0, 5.0), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("-0X1.999999999998P-4"),0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-10.0, 5.1), DEC::def), REP_DEC<double>(REP<double>(-10.0, 5.0), DEC::dac)), REP_DEC<double>(REP<double>(0.0,std::stod("0X1.999999999998P-4")), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-10.0, 5.0), DEC::com), REP_DEC<double>(REP<double>(-10.0, 5.0), DEC::def)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::def) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(0.9, 5.0), DEC::dac), REP_DEC<double>(REP<double>(1.0, 5.0), DEC::def)), REP_DEC<double>(REP<double>(std::stod("-0X1.9999999999998P-4"),0.0), DEC::def) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-0.0, 5.1), DEC::def), REP_DEC<double>(REP<double>(0.0, 5.0), DEC::def)), REP_DEC<double>(REP<double>(0.0,std::stod("0X1.999999999998P-4")), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(1.0, 5.0), DEC::dac), REP_DEC<double>(REP<double>(1.0, 5.0), DEC::com)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-5.0, 1.0), DEC::def), REP_DEC<double>(REP<double>(-1.0, 5.0), DEC::def)), REP_DEC<double>(REP<double>(-4.0,-4.0), DEC::def) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(std::stod("-0X1.999999999999AP-4"),std::stod("0X1.FFFFFFFFFFFFP+0")), DEC::def), REP_DEC<double>(REP<double>(-0.01,std::stod("0X1.999999999999AP-4")), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("-0X1.70A3D70A3D70BP-4"),std::stod("0X1.E666666666657P+0")), DEC::def) );

    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(MAX_D,MAX_D), DEC::com), REP_DEC<double>(REP<double>(-MAX_D,-MAX_D), DEC::com)), REP_DEC<double>(REP<double>(MAX_D,INF_D), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::com), REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::com)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::com), REP_DEC<double>(REP<double>(-MAX_D,std::stod("0X1.FFFFFFFFFFFFEP+1023")), DEC::com)), REP_DEC<double>(REP<double>(0.0,std::stod("0X1P+971")), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(-MAX_D,MAX_D), DEC::com), REP_DEC<double>(REP<double>(std::stod("-0X1.FFFFFFFFFFFFEP+1023"),MAX_D), DEC::com)), REP_DEC<double>(REP<double>(-std::stod("0X1P+971"),0.0), DEC::com) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(MIN_D,MIN_D), DEC::com), REP_DEC<double>(REP<double>(MIN_D,MIN_D), DEC::com)), REP_DEC<double>(REP<double>(0.0,0.0), DEC::com) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(MIN_D,MIN_D), DEC::com), REP_DEC<double>(REP<double>(-MIN_D,-MIN_D), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("0X1P-1021"),std::stod("0X1P-1021")), DEC::dac) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(std::stod("0X1P-1022"),std::stod("0X1.0000000000002P-1022")), DEC::dac), REP_DEC<double>(REP<double>(std::stod("0X1P-1022"),std::stod("0X1.0000000000001P-1022")), DEC::dac)), REP_DEC<double>(REP<double>(0.0,std::stod("0X0.0000000000001P-1022")), DEC::dac) );
    ...
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<double>(REP<double>(std::stod("-0X1P+0"),std::stod("0X1.FFFFFFFFFFFFFP-53")), DEC::com), REP_DEC<double>(REP<double>(std::stod("-0X1.FFFFFFFFFFFFEP-53"),std::stod("0X1P+0")), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("-0X1.FFFFFFFFFFFFFP-1"),std::stod("-0X1.FFFFFFFFFFFFEP-1")), DEC::dac) );
...
{
    BOOST_CHECK_EQUAL( F<float>::cancel_minus(REP_DEC<double>(REP<double>(-5.0,-0.9), DEC::com), REP_DEC<double>(REP<double>(-5.0,-1.0), DEC::dac)), REP_DEC<float>(REP<float>(0.0f, std::stof("0X1.99999AP-4")), DEC::dac) );
    BOOST_CHECK_EQUAL( F<float>::cancel_minus(REP_DEC<double>(REP<double>(-5.1,-0.9), DEC::dac), REP_DEC<double>(REP<double>(-5.0,-1.0), DEC::def)), REP_DEC<float>(REP<float>(std::stof("-0X1.99999AP-4"),std::stof("0X1.99999AP-4")), DEC::def) );
    BOOST_CHECK_EQUAL( F<double>::cancel_minus(REP_DEC<float>(REP<float>(-10.1f, 5.1f), DEC::def), REP_DEC<float>(REP<float>(-10.0f,5.0f), DEC::dac)), REP_DEC<double>(REP<double>(std::stod("-0x1.999ap-4"),std::stod("0x1.99998p-4")), DEC::def) );
